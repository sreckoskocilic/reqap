...
class LLMRouter:
    ...
    def __init__(self, cfg: Settings) -> None:
        ...
        if mode == "online":
            ...
            notes_be = ollama if cfg.hybrid_notes_backend == "ollama" else haiku
            notes_ctx = (
                ollama_ctx
                if cfg.hybrid_notes_backend == "ollama"
            ...
            self.notes_context_tokens = (
                cfg.groq_context_tokens - cfg.chunk_reserve_tokens
            )
